...
public class PetService {
    ...
    public Map<String, Set<String>> getPetsWithinRadius(String miles, String zipcode) {
        if (useDaily)
            return getPetsWithinRadiusDump(miles, zipcode);
        return getPetsWithinRadiusLive(miles, zipcode);
    }

    @SneakyThrows
    public Map<String, Set<String>> getPetsWithinRadiusDump(String milesStr, String zipcode) {
...
//                        }
    ...
    public Pet getCachedPet(String id) {
